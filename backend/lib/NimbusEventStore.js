...
class NimbusEventStore {
    ...
    /**
     *
     * @param {import("./nimbus_events/NimbusEventHandlerFactory")} factory
     */
     ...
     *
     * @param {string} id
     * @returns {import("./nimbus_events/events/NimbusEvent")}
     */
    getById(id) {
    ...
    /**
     * @public
     * @returns {Array<import("./nimbus_events/events/NimbusEvent")>}
     */
    getAll() {
        // noinspection JSValidateTypes
    ...
    /**
     * @public
     * @param {import("./nimbus_events/events/NimbusEvent")} event
     */
    raise(event) {
    ...
    /**
     * @param {import("./nimbus_events/events/NimbusEvent")} event
     * @param {import("./nimbus_events/handlers/NimbusEventHandler").INTERACTIONS} interaction
     */
...
module.exports = NimbusEventStore;
