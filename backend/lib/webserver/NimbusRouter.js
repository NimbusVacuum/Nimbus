...
class NimbusRouter {
    ...
    initRoutes() {
        ...
        this.router.get("/version", (req, res) => {
            res.json({
                release: Tools.GET_NIMBUS_VERSION(),
        ...
        this.router.put("/config/interfaces/mqtt", this.validator, (req, res) => {
            let mqttConfig = NimbusRouter.MAP_MQTT_CONFIG(req.body);
    ...
    initSSE() {
        ...
        Logger.onLogMessage((line) => {
             ...
             * Everything else using SSE in nimbus is a single-line string
             *
