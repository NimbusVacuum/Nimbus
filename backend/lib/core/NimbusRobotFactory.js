...
class NimbusRobotFactory {
    ...
    static getRobotImplementation(config) {
        ...
        if (robotConfig.implementation === "auto") {
            if (config.get("embedded") === true) {
                return NimbusRobotFactory.autodetectRobotImplementation();
            } else {
    ...
    static autodetectRobotImplementation() {
        ...
        if (matchedImplementation) {
            ...
            throw new Error("Couldn't find a suitable NimbusRobot implementation.");
        }
    }
}

module.exports = NimbusRobotFactory;
