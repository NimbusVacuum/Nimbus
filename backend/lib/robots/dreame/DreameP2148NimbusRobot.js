...
class DreameP2148NimbusRobot extends DreameGen2VSlamNimbusRobot {
    /**
     *
    ...
    constructor(options) {
        ...
        this.registerCapability(new capabilities.DreameConsumableMonitoringCapability({
            ...
            miot_properties: {
                ...
                secondary_filter: {
                    siid: DreameGen2NimbusRobot.MIOT_SERVICES.SECONDARY_FILTER.SIID,
                    piid: DreameGen2NimbusRobot.MIOT_SERVICES.SECONDARY_FILTER.PROPERTIES.TIME_LEFT.PIID
                }
            },
            miot_actions: {
                reset_main_brush: {
                ...
                reset_secondary_filter: {
                    siid: DreameGen2NimbusRobot.MIOT_SERVICES.SECONDARY_FILTER.SIID,
                    aiid: DreameGen2NimbusRobot.MIOT_SERVICES.SECONDARY_FILTER.ACTIONS.RESET.AIID
                }
            },
        }));
    }
...
module.exports = DreameP2148NimbusRobot;
