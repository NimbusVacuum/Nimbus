...
class DreameL10SUltraNimbusRobot extends DreameGen2LidarNimbusRobot {
    ...
    constructor(options) {
        ...
        this.registerCapability(new capabilities.DreameConsumableMonitoringCapability({
            ...
            miot_properties: {
                ...
                detergent: {
                    siid: DreameGen2NimbusRobot.MIOT_SERVICES.DETERGENT.SIID,
                    piid: DreameGen2NimbusRobot.MIOT_SERVICES.DETERGENT.PROPERTIES.PERCENT_LEFT.PIID
                }
            },
            miot_actions: {
                reset_main_brush: {
                ...
                reset_detergent: {
                    siid: DreameGen2NimbusRobot.MIOT_SERVICES.DETERGENT.SIID,
                    aiid: DreameGen2NimbusRobot.MIOT_SERVICES.DETERGENT.ACTIONS.RESET.AIID
                }
            },
        }));
...
module.exports = DreameL10SUltraNimbusRobot;
