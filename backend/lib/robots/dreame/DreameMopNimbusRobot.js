...
class DreameMopNimbusRobot extends DreameGen2LidarNimbusRobot {
    /**
     *
    ...
    constructor(options) {
        ...
        this.registerCapability(new capabilities.DreameMopDockWaterUsageControlCapability({
            ...
            presets: Object.keys(WATER_GRADES).map(k => {
                return new NimbusSelectionPreset({name: k, value: WATER_GRADES[k]});
            }),
            siid: DreameGen2NimbusRobot.MIOT_SERVICES.VACUUM_2.SIID,
        ...
        this.registerCapability(new capabilities.DreameMopDockCleanManualTriggerCapability({
            robot: this,
            siid: DreameGen2NimbusRobot.MIOT_SERVICES.VACUUM_2.SIID,
            aiid: DreameGen2NimbusRobot.MIOT_SERVICES.VACUUM_2.ACTIONS.MOP_DOCK_INTERACT.AIID,

            additionalCleanupParametersPiid: DreameGen2NimbusRobot.MIOT_SERVICES.VACUUM_2.PROPERTIES.ADDITIONAL_CLEANUP_PROPERTIES.PIID
        }));
    ...
    getStatePropertiesToPoll() {
        ...
        return [
            ...
            ...superProps.filter(e => {
                return !(
                    e.siid === DreameGen2NimbusRobot.MIOT_SERVICES.VACUUM_2.SIID &&
                    e.piid === DreameGen2NimbusRobot.MIOT_SERVICES.VACUUM_2.PROPERTIES.WATER_USAGE.PIID
                );
            }),
    ...
    parseAndUpdateState(data) {
        ...
        data.forEach(elem => {
            switch (elem.siid) {
                case DreameGen2NimbusRobot.MIOT_SERVICES.VACUUM_2.SIID: {
                    switch (elem.piid) {
                        case DreameGen2NimbusRobot.MIOT_SERVICES.VACUUM_2.PROPERTIES.MOP_DOCK_SETTINGS.PIID: {
...
module.exports = DreameMopNimbusRobot;
