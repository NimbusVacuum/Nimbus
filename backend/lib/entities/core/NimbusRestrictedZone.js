 ...
 */
class NimbusRestrictedZone extends SerializableEntity {
    /**
     * A ┌───┐ B
     *   │   │
     * D └───┘ C
     ...
     * @param {NimbusRestrictedZoneType} options.type
...
/**
 *  @typedef {string} NimbusRestrictedZoneType
 *  @enum {string}
 *
 */
NimbusRestrictedZone.TYPE = Object.freeze({
    REGULAR: "regular",
    MOP: "mop"
});

module.exports = NimbusRestrictedZone;
