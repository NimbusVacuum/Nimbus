...
function generateCapabilityLink(capability) {
    return "[" + capability + "](https://nimbus.cleaning/pages/usage/capabilities-overview.html#" + capability + ")";
}
...
const HIDDEN_IMPLEMENTATIONS = [
    "ViomiV7NimbusRobot",
    "RoborockM1SNimbusRobot",
    "RoborockS6MaxVNimbusRobot",
    "RoborockS7NimbusRobot",
    "DreameP2149NimbusRobot",
    "DreameL10SUltraNimbusRobot",
    "DreameL10SProNimbusRobot",
    "DreameX10PlusNimbusRobot",
    "DreameD9ProPlusNimbusRobot",
    "DreameD10SProNimbusRobot",
];
...
Object.keys(vendors).filter(v => v !== "Nimbus").sort().forEach((vendor, i) => {
    let vendorTocEntry = [
