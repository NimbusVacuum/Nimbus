...
Initially, the idea was to have a list of all open-source libraries and tools used in the making of Nimbus here,
...
Nimbus is licensed under <a href="https://github.com/NimbusVacuum/Nimbus/blob/main/LICENSE" rel="noopener" target="_blank">the Apache-2.0 license</a>,
