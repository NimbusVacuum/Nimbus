                ...
                <Box style={{width: "100%"}}>
                    ...
                    >
                        <Typography color="info">
                            When running Nimbus in embedded mode, it will advertise its presence on your local network
                            ...
                            things that may be able to auto-discover Nimbus instances on your network.
                        </Typography>
                    </InfoBox>
