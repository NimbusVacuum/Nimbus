...
import NimbusEvents from "./NimbusEvents";
...
const menuTree: Array<MenuEntry | MenuSubEntry | MenuSubheader> = [
    ...
    {
        kind: "MenuEntry",
        routeMatch: "/nimbus/system_information",
    ...
    {
        kind: "MenuEntry",
        routeMatch: "/nimbus/about",
        title: "About Nimbus",
        menuIcon: AboutIcon,
        menuText: "About Nimbus"
    },
];

const NimbusAppBar: React.FunctionComponent<{ paletteMode: PaletteMode, setPaletteMode: (newMode: PaletteMode) => void }> = ({
    paletteMode,
    setPaletteMode
}): JSX.Element => {
            ...
            >
                <List>
                    ...
                    <ListItem
                        button
                        component="a"
                        href="https://github.com/NimbusVacuum/Nimbus"
                        target="_blank"
                        rel="noopener"
                    >
                        <ListItemIcon>
                        ...
                        <ListItemText primary="NimbusVacuum/Nimbus"/>
                    </ListItem>
                </List>
            </Box>
        );
