...
import {useNimbusEventsInteraction, useNimbusEventsQuery} from "../api";
import {eventControls} from "./NimbusEventControls";
import ReloadableCard from "./ReloadableCard";
import styles from "./NimbusEvents.module.css";

const NimbusEvents = (): JSX.Element => {
    const {
        data: eventData,
    ...
    } = useNimbusEventsQuery();
    const {mutate: interactWithEvent} = useNimbusEventsInteraction();
